          ...
          <div className="max-w-6xl mx-auto mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map((relatedPost) => (
                <div key={relatedPost.slug} className="group bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-lg overflow-hidden transition-colors duration-200">
                  {relatedPost.image && (
